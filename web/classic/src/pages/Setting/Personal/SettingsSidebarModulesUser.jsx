  ...
  const generateDefaultConfig = () => {
    ...
    if (isSidebarSectionAllowed('personal')) {
      defaultConfig.personal = {
        ...
        topupBills: isSidebarModuleAllowed('personal', 'topupBills'),
        invoices: isSidebarModuleAllowed('personal', 'invoices'),
    ...
    if (isSidebarSectionAllowed('admin')) {
      defaultConfig.admin = {
        ...
        invoiceStats: isSidebarModuleAllowed('admin', 'invoiceStats'),
